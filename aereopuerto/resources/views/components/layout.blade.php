...
{{--                 <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">
                 ...
                 <div class="text-3xl"><a href="/"> Vuelos </a> </div>
                ...
                <div>
                    <nav>
                        ...
                        <form method="GET" action="/reservas" class="hover:text-blue-500 hover:underline"> <input type="submit" value="Tus reservas">@csrf</form>
                    @else
