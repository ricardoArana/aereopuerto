    ...
    <div class="font-sans text-gray-900 antialiased">
        <header class="w-full h-10">
            <div class="flex justify-between mx-36 my-10 p-1 border-b-2 border-y-blue-900">
                <a class="text-3xl mr-24 ml-4 hover:animate-waving hover:text-blue-800" href="#">Logo</a>
                <a class="text-3xl hover:animate-waving hover:text-blue-800" href="#">Cines</a>
                <a class="text-3xl hover:animate-waving hover:text-blue-800" href="#">Películas</a>
                <a class="text-3xl mr-4 hover:animate-waving hover:text-blue-800" href="#">F&Q</a>
            </div>
        </header>
        <main class="mx-10 h-auto mt-4 pb-10 bg-blue-900">
            {{ $slot }}
        </main>
        <footer class="flex justify-center bg-blue-800 w-full h-96 mt-10">
            <div class="bg-blue-200 mt-4 w-full mx-10 h-5/6">
                <div class="grid grid-rows-3 grid-flow-col gap-4 bg-blue-200 h-4/5">
                    ...
                    <div class="col-span-2 row-span-4 text-right mr-44 mt-6">
                        <p class="text-2xl">¿Tienes algún problema?</p>
                        <p class="text-xl mr-3 mt-2"> <a class="text-blue-600" href="#">Contacta</a> con nosotros</p>
                    </div>
                </div>
            </div>
